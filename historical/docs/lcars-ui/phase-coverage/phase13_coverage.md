...
- Its visual-regression references were superseded by canonical target-bank acceptance in Phase 6.
...
- At Phase 13 time, `make ci` included `visual-regression` as a default gate. That default was later replaced with canonical target-bank acceptance.
