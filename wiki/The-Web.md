...
LCARS-WebUI 4.5.0 provides eight native instruments for The Web v0.3 and v0.3.1
...
```python
def ui() -> None:
    lcars.config("The Web", subtitle="Knowledge Support Console", settings_page=False)
