...
- **Verification:** `tests/unit/test_widgets.py::test_pyproject_phase0_dependencies_and_strict_mypy_config`.
...
- **Verification:** `tests/unit/test_placeholder.py::test_makefile_targets_present`, `tests/unit/test_phase0_coverage.py::test_phase0_makefile_commands_match_plan`.
...
- **Verification:** `tests/contracts/test_manifest_schema.py`, `tests/contracts/test_protocol_schema.py`, `tests/unit/test_phase0_coverage.py::test_phase0_scripts_execute_successfully`.
