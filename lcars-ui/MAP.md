...
> Re-run `python codemap.py` to refresh after code changes.
...
| JS files | 22 |
| CSS/SCSS/LESS files | 7 |
| HTML/template files | 3 |
| SQL files | 0 |
| Shell scripts | 1 |
| Python classes | 239 |
| Python functions | 632 |
| API routes | 10 |
...
│       ├── _static
│       │   ├── assets
│       │   │   ├── GLTFLoader-qXE60D7C.js
│       │   │   ├── GraphWorkspace-DuDnQU1Q.css
│       │   │   ├── GraphWorkspace-DzGyTeHL.js
│       │   │   ├── HintLayer-CNy_Bm4t.js
│       │   │   ├── hls-BmBgVleQ.js
│       │   │   ├── index-_sZRY3mr.js
│       │   │   ├── index-F2vmfoB3.css
│       │   │   ├── jsx-runtime-OQpaS_Dv.js
│       │   │   ├── lightweight-charts.production-B7hGuU5E.js
│       │   │   ├── NodeCanvas-CYQa7F0Y.js
│       │   │   ├── NodeCanvas-rmK9se4N.css
│       │   │   ├── OrbitControls-BviZQBC4.js
│       │   │   ├── Rearrange-DQ2Uyb_S.js
│       │   │   ├── three.module-C5rh5wLt.js
│       │   │   └── ThreeSceneCanvas-BdKWwTuE.js
│       │   ├── .gitkeep
│       │   └── index.html
│       ├── core
│       │   ├── __init__.py
...
- lcars_ui.dsl.api.{alert, anchor_card, append_log, assertion_card, atom_legend, auto, bar, box, bracket, button, candlestick, chart, checkbox, col, columns, commitment_selector, composition, config, console, constraint_band, contender_list, context_tags, control_panel, data_panel, diagnostic, environments, file_upload, form, fr, frontier, gap_panel, gauge, graph_workspace, header, hide_hint, hint, input_column, live, log, markdown, metric, mic_button, minmax, nav, node_canvas, notify, number_input, padd, page, popup, progress, px, radio, radio_toggle, raw, renko, row, run, section, select, set_alert_condition, set_theme, shader, show_hint, sparkline, support_panel, sweep, table, text, text_input, three_scene, toggle, tri_state, update, video_hls}
...
- __future__.{annotations}
- lcars_ui.core.widget_base.{Hint, LayoutSizing, LcarsColor}
...
- lcars_ui.widgets.media.{LogViewer, MicButton, ThreeScene, VideoHls}
- lcars_ui.widgets.options.{AlertOptions, AlertState, ButtonOptions, ChartOptions, ChartState, ChoiceOptions, ContainerOptions, ContainerState, FinancialChartOptions, FormOptions, HeaderOptions, InteractionOptions, LogOptions, LogState, MarkdownOptions, MeterOptions, MetricOptions, MicOptions, MicResult, NumberInputOptions, ShaderOptions, SparklineOptions, TableOptions, TableState, TextInputOptions, TextOptions, ThreeSceneOptions, ThreeSceneState, ToggleOptions, VideoOptions, VideoState}
- lcars_ui.widgets.primitives.{Alert, Markdown, ProgressBar, StatusTile, Text}
...
| `src/lcars_ui/__init__.py` | `__version__` | `` | `'5.3.0'` | 205 |
| `src/lcars_ui/__init__.py` | `__all__` | `` | `['__version__', 'config', 'run', 'live', 'nav', 'page', 'composition', 'px', 'fr` | 207 |
...
| `src/lcars_ui/core/models.py` | `Widget` | `` | `Annotated[Text | StatusTile | Alert | Button | Toggle | Checkbox | Radio | Radio` | 154 |
| `src/lcars_ui/core/models.py` | `_RECURSIVE_WIDGET_NAMESPACE` | `` | `{'Widget': Widget, 'Literal': Literal}` | 204 |
| `src/lcars_ui/core/models.py` | `__all__` | `` | `['Meta', 'Header', 'SidebarSegment', 'SidebarItem', 'Sidebar', 'Layout', 'Widget` | 301 |
...
| `src/lcars_ui/dsl/_builder.py` | `__all__` | `` | `['_ManifestBuilder', '_ColumnContext']` | 447 |
...
| `src/lcars_ui/dsl/api.py` | `ZoneHint` | `` | `Literal['primary', 'side', 'readout', 'dock', 'rail', 'full']` | 150 |
| `src/lcars_ui/dsl/api.py` | `PanelAspect` | `` | `Literal['wide', 'tall', 'square', 'flex']` | 151 |
| `src/lcars_ui/dsl/api.py` | `LayoutSizing` | `` | `Literal['fill', 'content']` | 152 |
| `src/lcars_ui/dsl/api.py` | `_live_fn` | `Callable[[], None] | None` | `None` | 155 |
| `src/lcars_ui/dsl/api.py` | `_live_interval` | `float` | `5.0` | 156 |
| `src/lcars_ui/dsl/api.py` | `_STRICT_COLUMN_MIN_WIDTH` | `` | `48` | 157 |
| `src/lcars_ui/dsl/api.py` | `_STRICT_COLUMN_MAX_WIDTH` | `` | `150` | 158 |
| `src/lcars_ui/dsl/api.py` | `_StateModel` | `` | `TypeVar('_StateModel', bound=BaseModel)` | 159 |
| `src/lcars_ui/dsl/api.py` | `__all__` | `` | `['config', 'run', 'live', 'nav', 'page', 'row', 'col', 'columns', 'section', 'bo` | 3683 |
...
| `src/lcars_ui/widgets/options.py` | `SortAs` | `` | `Literal['auto', 'text', 'natural', 'number', 'bytes', 'percent', 'duration', 'cu` | 184 |
| `src/lcars_ui/widgets/options.py` | `Vec3` | `` | `tuple[float, float, float]` | 369 |
| `src/lcars_ui/widgets/options.py` | `__all__` | `` | `['ScalarValue', 'InteractionMode', 'FeedbackState', 'CommitMode', 'WidgetFeedbac` | 461 |
...
| `src/lcars_ui/widgets/web.py` | `ConstraintRepresentation` | `` | `Literal['INTERVAL', 'INEQUALITY', 'COVARIANCE', 'LIKELIHOOD', 'CONTOUR', 'FUNCTI` | 29 |
| `src/lcars_ui/widgets/web.py` | `GapType` | `` | `Literal['RELATIONAL', 'MECHANISTIC', 'REDUCTION', 'EVIDENTIAL', 'ONTOLOGICAL']` | 38 |
| `src/lcars_ui/widgets/web.py` | `CompletenessState` | `` | `Literal['complete', 'partial']` | 39 |
| `src/lcars_ui/widgets/web.py` | `__all__` | `` | `['AnchorCard', 'AnchorData', 'AssertionCard', 'AssertionData', 'CommitmentData',` | 310 |
...
### `src/lcars_ui/core/models.py` → `Column(BaseModel)` *(line 217)*
...
### `src/lcars_ui/core/models.py` → `Manifest(BaseModel)` *(line 290)*
...
### `src/lcars_ui/core/models.py` → `Page(BaseModel)` *(line 253)*

> A logical application page.

*No methods.*

### `src/lcars_ui/core/models.py` → `Row(BaseModel)` *(line 233)*
...
### `src/lcars_ui/dsl/api.py` → `_AuthoredCompositionContext` *(line 837)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `__init__` |  | `builder: _ManifestBuilder, widget: AuthoredComposition` | `None` | 838 |  |
| `area` |  | `area_id: str` | `Generator[None, None, None]` | 843 |  |

### `src/lcars_ui/dsl/api.py` → `_LcarsBoxContext` *(line 746)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `__init__` |  | `builder: _ManifestBuilder, widget: LcarsBox, state: ContainerState | None` | `None` | 747 |  |
| `left_inputs` |  | `—` | `Generator[None, None, None]` | 758 |  |
| `right_inputs` |  | `—` | `Generator[None, None, None]` | 763 |  |
| `main` |  | `—` | `Generator[None, None, None]` | 768 |  |
| `side` |  | `—` | `Generator[None, None, None]` | 773 |  |

### `src/lcars_ui/dsl/api.py` → `_LcarsSweepContext` *(line 799)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `__init__` |  | `builder: _ManifestBuilder, widget: LcarsSweep, state: ContainerState | None` | `None` | 800 |  |
| `header` |  | `—` | `Generator[None, None, None]` | 811 |  |
| `column_inputs` |  | `—` | `Generator[None, None, None]` | 816 |  |
| `left` |  | `—` | `Generator[None, None, None]` | 821 |  |
| `right` |  | `—` | `Generator[None, None, None]` | 826 |  |

### `src/lcars_ui/dsl/api.py` → `_NoOpBoxContext` *(line 725)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `__init__` |  | `state: ContainerState | None` | `None` | 726 |  |
| `left_inputs` |  | `—` | `Generator[None, None, None]` | 730 |  |
| `right_inputs` |  | `—` | `Generator[None, None, None]` | 734 |  |
| `main` |  | `—` | `Generator[None, None, None]` | 738 |  |
| `side` |  | `—` | `Generator[None, None, None]` | 742 |  |

### `src/lcars_ui/dsl/api.py` → `_NoOpCompositionContext` *(line 831)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `area` |  | `—` | `Generator[None, None, None]` | 833 |  |

### `src/lcars_ui/dsl/api.py` → `_NoOpContext` *(line 717)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `__enter__` |  | `—` | `_NoOpContext` | 718 |  |
| `__exit__` |  | `—` | `None` | 721 |  |

### `src/lcars_ui/dsl/api.py` → `_NoOpSweepContext` *(line 778)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `__init__` |  | `state: ContainerState | None` | `None` | 779 |  |
| `header` |  | `—` | `Generator[None, None, None]` | 783 |  |
| `column_inputs` |  | `—` | `Generator[None, None, None]` | 787 |  |
| `left` |  | `—` | `Generator[None, None, None]` | 791 |  |
| `right` |  | `—` | `Generator[None, None, None]` | 795 |  |
...
### `src/lcars_ui/widgets/options.py` → `AxisOptions(BaseModel)` *(line 277)*
...
### `src/lcars_ui/widgets/options.py` → `ChartOptions(BaseOptions)` *(line 290)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `ChartState(BaseModel)` *(line 318)*
...
### `src/lcars_ui/widgets/options.py` → `ContainerOptions(BaseOptions)` *(line 448)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `ContainerState(BaseModel)` *(line 456)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `FinancialChartOptions(BaseOptions)` *(line 309)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `FormOptions(BaseOptions)` *(line 176)*
...
### `src/lcars_ui/widgets/options.py` → `LogOptions(BaseOptions)` *(line 333)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `LogState(BaseModel)` *(line 344)*
...
### `src/lcars_ui/widgets/options.py` → `MicOptions(BaseOptions)` *(line 434)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `MicResult(BaseModel)` *(line 442)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `NumberInputOptions(BaseOptions)` *(line 167)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `ReferenceLine(BaseModel)` *(line 284)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `ShaderOptions(BaseOptions)` *(line 326)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `SparklineOptions(BaseOptions)` *(line 301)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TableColumn(BaseModel)` *(line 199)*

> Enhanced table column definition.

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TableFilter(BaseModel)` *(line 226)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TableOptions(BaseOptions)` *(line 243)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TablePagination(BaseModel)` *(line 232)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TableSelection(BaseModel)` *(line 238)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TableSort(BaseModel)` *(line 221)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TableState(BaseModel)` *(line 267)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `TextInputOptions(BaseOptions)` *(line 158)*
...
### `src/lcars_ui/widgets/options.py` → `ThreeSceneCamera(BaseModel)` *(line 372)*

> Initial perspective-camera placement for a managed Three.js scene.

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `_validate_clip_planes` |  | `—` | `ThreeSceneCamera` | 382 |  |

### `src/lcars_ui/widgets/options.py` → `ThreeSceneControls(BaseModel)` *(line 388)*

> Orbit/pan/zoom behaviour. The renderer owns the controls; this configures them.

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `_validate_distances` |  | `—` | `ThreeSceneControls` | 402 |  |

### `src/lcars_ui/widgets/options.py` → `ThreeSceneOptions(BaseOptions)` *(line 408)*

> Renderer-owned scene settings. Mirrors ShaderOptions where the concerns overlap.

*No methods.*

### `src/lcars_ui/widgets/options.py` → `ThreeSceneState(BaseModel)` *(line 424)*
...
### `src/lcars_ui/widgets/options.py` → `VideoOptions(BaseOptions)` *(line 352)*

*No methods.*

### `src/lcars_ui/widgets/options.py` → `VideoState(BaseModel)` *(line 361)*
...
### `src/lcars_ui/widgets/web.py` → `AnchorCard(BaseWidget)` *(line 267)*

> Empirical or formal anchor and its source.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `AnchorData(BaseModel)` *(line 151)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `AssertionCard(BaseWidget)` *(line 257)*

> Primary assertion view with optional context qualifier rendering.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `AssertionData(BaseModel)` *(line 137)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `CommitmentData(BaseModel)` *(line 223)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `_active_is_available` |  | `—` | `CommitmentData` | 231 |  |

### `src/lcars_ui/widgets/web.py` → `CommitmentOption(WebRef)` *(line 219)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `CommitmentSelector(BaseWidget)` *(line 302)*

> Commitment-set selector with separate consequence sets.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `ConstraintBand(BaseWidget)` *(line 284)*

> An excluded interval with positioned and uncommitted claims.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `ConstraintCondition(NumericInterval)` *(line 186)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `ConstraintData(BaseModel)` *(line 195)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `ContextQualifier(BaseModel)` *(line 131)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `FrameworkRef(WebRef)` *(line 127)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `Frontier(BaseWidget)` *(line 248)*

> One-hop traversal control for a node and its immediate neighbours.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `FrontierCurrent(WebRef)` *(line 111)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `FrontierData(BaseModel)` *(line 121)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `FrontierItem(WebRef)` *(line 115)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `GapContender(WebRef)` *(line 205)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `GapData(BaseModel)` *(line 209)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `GapPanel(BaseWidget)` *(line 292)*

> A missing explanatory bridge and optional contenders.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `NumericInterval(BaseModel)` *(line 175)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `_ordered_bounds` |  | `—` | `NumericInterval` | 180 |  |

### `src/lcars_ui/widgets/web.py` → `PositionedClaim(WebRef)` *(line 191)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `QuantityRef(WebRef)` *(line 171)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `SourceRef(BaseModel)` *(line 146)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `SupportAtom(WebRef)` *(line 49)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `SupportCompleteness(BaseModel)` *(line 57)*

> Structured completeness metadata for a :class:`SupportData` result.

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `unsafe_for_negative_conclusions` |  | `—` | `bool` | 71 | Whether an absence/negative conclusion drawn from this result may be wrong. |

### `src/lcars_ui/widgets/web.py` → `SupportData(BaseModel)` *(line 76)*

| Method | Async | Params | Returns | Line | Doc |
|--------|-------|--------|---------|------|-----|
| `_derive_completeness_or_truncated` |  | `cls: Any, data: object` | `object` | 84 |  |
| `_completeness_truncated_consistent` |  | `—` | `SupportData` | 103 |  |

### `src/lcars_ui/widgets/web.py` → `SupportEnvironment(BaseModel)` *(line 53)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `SupportPanel(BaseWidget)` *(line 237)*

> Alternative support environments for one node.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `TriState(BaseWidget)` *(line 275)*

> Neutral three-valued query result.

*No methods.*

### `src/lcars_ui/widgets/web.py` → `TriStateData(BaseModel)` *(line 162)*

*No methods.*

### `src/lcars_ui/widgets/web.py` → `WebRef(BaseModel)` *(line 42)*
...
| `src/lcars_ui/dsl/api.py` | `_coerce_hint` |  | `value: str | Hint | None` | `Hint | None` | 162 | Normalize the ``hint=`` kwarg. |
| `src/lcars_ui/dsl/api.py` | `_get_or_init_ctx` |  | `—` | `_LCARSContext` | 174 |  |
| `src/lcars_ui/dsl/api.py` | `_require_builder` |  | `ctx: _LCARSContext` | `_ManifestBuilder` | 178 | Return the current builder or raise a clear error if called outside run(). |
| `src/lcars_ui/dsl/api.py` | `_resolve_id` |  | `label: str, explicit_id: str | None` | `str` | 188 |  |
| `src/lcars_ui/dsl/api.py` | `_get_session_store` |  | `ctx: _LCARSContext` | `dict[str, Any]` | 201 |  |
| `src/lcars_ui/dsl/api.py` | `_server_interaction_state` |  | `—` | `_StateModel | None` | 205 | Return validated per-session state for an opt-in server interaction. |
| `src/lcars_ui/dsl/api.py` | `_normalize_choice_options` |  | `values: list[str | SelectOption | dict[str, Any]]` | `list[SelectOption]` | 250 |  |
| `src/lcars_ui/dsl/api.py` | `_container_interaction_state` |  | `—` | `ContainerState` | 268 |  |
| `src/lcars_ui/dsl/api.py` | `_warn_strict_page_level_layout` |  | `—` | `None` | 284 |  |
| `src/lcars_ui/dsl/api.py` | `_constrain_strict_column_width` |  | `width_px: int` | `int` | 304 |  |
| `src/lcars_ui/dsl/api.py` | `_validate_css_track` |  | `value: str` | `str` | 328 | Accept declarative CSS sizing expressions without admitting declarations. |
| `src/lcars_ui/dsl/api.py` | `px` |  | `value: int | float` | `str` | 335 | Return a validated fixed-size authored-composition track. |
| `src/lcars_ui/dsl/api.py` | `fr` |  | `value: int | float` | `str` | 342 | Return a validated fractional authored-composition track. |
| `src/lcars_ui/dsl/api.py` | `auto` |  | `—` | `str` | 349 | Return an intrinsic authored-composition track. |
| `src/lcars_ui/dsl/api.py` | `minmax` |  | `minimum: str, maximum: str` | `str` | 354 | Return a validated ``minmax()`` authored-composition track. |
| `src/lcars_ui/dsl/api.py` | `_iter_widgets_in_tree` |  | `widgets: list[Any]` | `Generator[Any, None, None]` | 361 |  |
| `src/lcars_ui/dsl/api.py` | `_index_form_children` |  | `manifest: Any` | `dict[str, list[str]]` | 410 |  |
| `src/lcars_ui/dsl/api.py` | `config` |  | `name: str` | `None` | 426 | Set one-time app-level configuration (call from inside or outside ui_fn). |
| `src/lcars_ui/dsl/api.py` | `run` |  | `ui_fn: Callable[[], None]` | `None` | 463 | Build the manifest from ui_fn, start uvicorn, open the browser. |
| `src/lcars_ui/dsl/api.py` | `live` |  | `interval: float` | `Callable[[Callable[[], None]], Callable[[], None]]` | 573 | Decorator: call the decorated function every *interval* seconds (live polling). |
| `src/lcars_ui/dsl/api.py` | `nav` |  | `label: str` | `None` | 599 | Add a sidebar navigation item. |
| `src/lcars_ui/dsl/api.py` | `page` |  | `title: str` | `Generator[None, None, None]` | 637 | Context manager: declare a named page. |
| `src/lcars_ui/dsl/api.py` | `columns` |  | `widths: list[str]` | `list[Any]` | 674 | Declare a multi-column layout row; returns list of context managers. |
| `src/lcars_ui/dsl/api.py` | `row` |  | `—` | `Generator[None, None, None]` | 684 | Context manager: start a row block that contains one or more cols. |
| `src/lcars_ui/dsl/api.py` | `col` |  | `width: str` | `Generator[None, None, None]` | 697 | Context manager: start a column block inside a row. |
| `src/lcars_ui/dsl/api.py` | `section` |  | `label: str` | `Generator[None, None, None]` | 710 | Visual grouping helper with a heading and nested body widgets. |
| `src/lcars_ui/dsl/api.py` | `composition` |  | `—` | `Generator[_AuthoredCompositionContext | _NoOpCompositionContext, None, None]` | 888 | Declare an explicit, topology-preserving CSS Grid composition. |
| `src/lcars_ui/dsl/api.py` | `hint` |  | `target: str | None` | `Generator[Hint | None, None, None]` | 926 | Context manager: attach a floating hint body to an already-declared widget. |
| `src/lcars_ui/dsl/api.py` | `box` |  | `title: str | None` | `Generator[_LcarsBoxContext | _NoOpBoxContext, None, None]` | 994 | Context manager: compose an lcars_box container. |
| `src/lcars_ui/dsl/api.py` | `sweep` |  | `title: str | None` | `Generator[_LcarsSweepContext | _NoOpSweepContext, None, None]` | 1067 | Context manager: compose an lcars_sweep container. |
| `src/lcars_ui/dsl/api.py` | `bracket` |  | `—` | `Generator[ContainerState, None, None]` | 1131 | Context manager: compose an lcars_bracket container. |
| `src/lcars_ui/dsl/api.py` | `popup` |  | `title: str` | `Generator[None, None, None]` | 1178 | Context manager: declare a movable window above the page deck. |
| `src/lcars_ui/dsl/api.py` | `console` |  | `title: str` | `Generator[_LcarsSweepContext | _NoOpSweepContext, None, None]` | 1233 | Phase 13 layout recipe: sweep-led console composition. |
| `src/lcars_ui/dsl/api.py` | `padd` |  | `title: str` | `Generator[_LcarsSweepContext | _NoOpSweepContext, None, None]` | 1276 | Phase 13 layout recipe: dense single-column PADD sweep. |
| `src/lcars_ui/dsl/api.py` | `diagnostic` |  | `title: str` | `Generator[_LcarsBoxContext | _NoOpBoxContext, None, None]` | 1319 | Phase 13 layout recipe: full-frame diagnostic container. |
| `src/lcars_ui/dsl/api.py` | `data_panel` |  | `title: str` | `Generator[_LcarsBoxContext | _NoOpBoxContext, None, None]` | 1362 | Phase 13 layout recipe: data-focused LCARS box panel. |
| `src/lcars_ui/dsl/api.py` | `control_panel` |  | `title: str` | `Generator[_LcarsBoxContext | _NoOpBoxContext, None, None]` | 1405 | Phase 13 layout recipe: control-focused panel with right input column default. |
| `src/lcars_ui/dsl/api.py` | `input_column` |  | `—` | `Generator[None, None, None]` | 1448 | Route nested widgets into the nearest enclosing lcars.box() input column. |
| `src/lcars_ui/dsl/api.py` | `raw` |  | `—` | `Generator[None, None, None]` | 1464 | Escape hatch: bypass strict auto-paneling for this local subtree. |
| `src/lcars_ui/dsl/api.py` | `form` |  | `label: str, action_id: str` | `Generator[None, None, None]` | 1484 | Context manager: define a grouped form with nested input widgets. |
| `src/lcars_ui/dsl/api.py` | `_apply_web_layout_hints` |  | `widget: Any` | `None` | 1536 |  |
| `src/lcars_ui/dsl/api.py` | `_enclosing_web_panel` |  | `builder: _ManifestBuilder, widget_type: str` | `Any` | 1556 |  |
| `src/lcars_ui/dsl/api.py` | `support_panel` |  | `title: str` | `Generator[None, None, None]` | 1569 | Compose alternative support environments for ``node``. |
| `src/lcars_ui/dsl/api.py` | `environments` |  | `data: SupportData | dict[str, Any]` | `None` | 1616 | Populate the alternative environments of an enclosing support panel. |
| `src/lcars_ui/dsl/api.py` | `atom_legend` |  | `—` | `None` | 1632 | Show the empirical/formal/assumption legend in a support panel. |
| `src/lcars_ui/dsl/api.py` | `frontier` |  | `data: FrontierData | dict[str, Any]` | `str | None` | 1639 | Render one-hop traversal and return the clicked neighbour id. |
| `src/lcars_ui/dsl/api.py` | `assertion_card` |  | `data: AssertionData | dict[str, Any]` | `Generator[None, None, None]` | 1692 | Compose the primary assertion view. |
| `src/lcars_ui/dsl/api.py` | `context_tags` |  | `—` | `None` | 1738 | Render all context roles on the enclosing assertion card. |
| `src/lcars_ui/dsl/api.py` | `anchor_card` |  | `data: AnchorData | dict[str, Any]` | `None` | 1745 | Render an empirical or formal evidence anchor. |
| `src/lcars_ui/dsl/api.py` | `tri_state` |  | `data: TriStateData | dict[str, Any]` | `bool` | 1787 | Render YES/NO/UNKNOWN; return true when EXACT escalation is requested. |
| `src/lcars_ui/dsl/api.py` | `constraint_band` |  | `data: ConstraintData | dict[str, Any]` | `None` | 1836 | Render an interval constraint, or an explicit unrendered representation. |
| `src/lcars_ui/dsl/api.py` | `gap_panel` |  | `data: GapData | dict[str, Any]` | `Generator[None, None, None]` | 1879 | Compose a missing explanatory bridge and its contenders. |
| `src/lcars_ui/dsl/api.py` | `contender_list` |  | `—` | `None` | 1925 | Render contenders, including the valid empty state, on a gap panel. |
| `src/lcars_ui/dsl/api.py` | `commitment_selector` |  | `data: CommitmentData | dict[str, Any]` | `str | None` | 1932 | Render commitment choices and return the newly selected id. |
| `src/lcars_ui/dsl/api.py` | `header` |  | `text_value: str` | `None` | 1983 | Render an LCARS section header widget. |
| `src/lcars_ui/dsl/api.py` | `bar` |  | `text_value: str | None` | `None` | 2021 | Render a structural LCARS bar with optional terminals and label. |
| `src/lcars_ui/dsl/api.py` | `text` |  | `content: str` | `None` | 2052 | Render a text block. |
| `src/lcars_ui/dsl/api.py` | `markdown` |  | `content: str` | `None` | 2092 | Render a markdown block. |
| `src/lcars_ui/dsl/api.py` | `metric` |  | `label: str, value: str` | `None` | 2128 | Render a StatusTile metric readout. |
| `src/lcars_ui/dsl/api.py` | `alert` |  | `message: str` | `AlertState | None` | 2168 | Render an alert banner and return state for server-controlled interactions. |
| `src/lcars_ui/dsl/api.py` | `progress` |  | `label: str, value: float` | `None` | 2220 | Render a progress bar. |
| `src/lcars_ui/dsl/api.py` | `chart` |  | `data: Any` | `ChartState | None` | 2260 | Render a LineChart. data: list[float] | dict[str, list[float]] | pd.DataFrame. |
| `src/lcars_ui/dsl/api.py` | `sparkline` |  | `data: Any` | `None` | 2310 | Render a Sparkline. |
| `src/lcars_ui/dsl/api.py` | `candlestick` |  | `data: Any` | `ChartState | None` | 2350 | Render a live, zoomable OHLC candlestick chart. |
| `src/lcars_ui/dsl/api.py` | `renko` |  | `data: Any, brick_size: float` | `ChartState | None` | 2410 | Render a live, zoomable Renko brick chart computed from a price series. |
| `src/lcars_ui/dsl/api.py` | `shader` |  | `fragment_shader: str` | `None` | 2470 | Render an animated WebGL fragment-shader viewport. |
| `src/lcars_ui/dsl/api.py` | `gauge` |  | `label: str, value: float` | `None` | 2517 | Render a circular gauge readout. |
| `src/lcars_ui/dsl/api.py` | `table` |  | `data: Any` | `TableState | None` | 2565 | Render a Table. data: list[list] | list[dict] | pd.DataFrame. |
| `src/lcars_ui/dsl/api.py` | `log` |  | `stream_id: str` | `LogState | None` | 2633 | Render a LogViewer. |
| `src/lcars_ui/dsl/api.py` | `video_hls` |  | `src: str` | `VideoState | None` | 2696 | Render an HLS video player descriptor. |
| `src/lcars_ui/dsl/api.py` | `node_canvas` |  | `document: GraphDocument | dict[str, Any]` | `NodeCanvasState | None` | 2750 | Render an editable node-graph canvas. |
| `src/lcars_ui/dsl/api.py` | `graph_workspace` |  | `workspace: GraphWorkspaceDocument | dict[str, Any]` | `GraphWorkspaceState | None` | 2818 | Render a canonical graph and its distinct proposal working plane. |
| `src/lcars_ui/dsl/api.py` | `three_scene` |  | `module: str` | `ThreeSceneState | None` | 2871 | Render a managed Three.js viewport driven by a project scene module. |
| `src/lcars_ui/dsl/api.py` | `mic_button` |  | `action_id: str` | `MicResult | None` | 2946 | Render a microphone capture action button. |
| `src/lcars_ui/dsl/api.py` | `file_upload` |  | `label: str` | `list[UploadedFile]` | 3010 | Render a drag/drop file uploader and return files during its HANDLE rerun. |
| `src/lcars_ui/dsl/api.py` | `button` |  | `label: str` | `bool` | 3091 | Render a button. Returns True only in the rerun triggered by this click. |
| `src/lcars_ui/dsl/api.py` | `toggle` |  | `label: str` | `bool` | 3145 | Render a toggle. Returns current bool state. |
| `src/lcars_ui/dsl/api.py` | `checkbox` |  | `label: str` | `bool` | 3195 | Render a checkbox. Returns current bool state. |
| `src/lcars_ui/dsl/api.py` | `select` |  | `label: str, options: list[str | SelectOption | dict[str, Any]]` | `str | list[str]` | 3245 | Render a select dropdown. Returns current selected value. |
| `src/lcars_ui/dsl/api.py` | `radio` |  | `label: str, options: list[str | SelectOption | dict[str, Any]]` | `str` | 3324 | Render a radio button group. Returns current selected value. |
| `src/lcars_ui/dsl/api.py` | `radio_toggle` |  | `label: str, options: list[str | SelectOption | dict[str, Any]]` | `str` | 3378 | Render a segmented radio toggle group. Returns current selected value. |
| `src/lcars_ui/dsl/api.py` | `text_input` |  | `label: str` | `str` | 3432 | Render a text input. Returns current text value. |
| `src/lcars_ui/dsl/api.py` | `number_input` |  | `label: str` | `float` | 3497 | Render a numeric input. Returns current float value. |
| `src/lcars_ui/dsl/api.py` | `update` |  | `widget_id: str` | `None` | 3574 | Publish a widget_update event (HANDLE/LIVE only; no-op in BUILD). |
| `src/lcars_ui/dsl/api.py` | `show_hint` |  | `widget_id: str` | `None` | 3586 | Open a widget's hint from Python (HANDLE/LIVE only; no-op in BUILD). |
| `src/lcars_ui/dsl/api.py` | `hide_hint` |  | `widget_id: str` | `None` | 3594 | Close a widget's hint from Python (HANDLE/LIVE only; no-op in BUILD). |
| `src/lcars_ui/dsl/api.py` | `notify` |  | `message: str` | `None` | 3599 | Publish a configurable notification event (HANDLE/LIVE only). |
| `src/lcars_ui/dsl/api.py` | `append_log` |  | `stream_id: str` | `None` | 3626 | Publish a log_chunk event (HANDLE/LIVE only; no-op in BUILD). |
| `src/lcars_ui/dsl/api.py` | `set_alert_condition` |  | `level: Literal['normal', 'yellow', 'red']` | `None` | 3638 | Set the shipwide alert condition live (HANDLE/LIVE only; no-op in BUILD). |
| `src/lcars_ui/dsl/api.py` | `set_theme` |  | `theme: Literal['galaxy', 'nemesis', 'tng', 'outpost', 'cardassian', 'klingon', 'romulan', 'ferengi', 'gruvbox']` | `None` | 3655 | Switch the active theme live (HANDLE/LIVE only; no-op in BUILD). |
...
| `tests/integration/test_dsl_roundtrip.py` | `test_toggle_persists_value` |  | `—` | `None` | 171 |  |
| `tests/integration/test_dsl_roundtrip.py` | `test_select_persists_value` |  | `—` | `None` | 190 |  |
| `tests/integration/test_dsl_roundtrip.py` | `test_create_app_dsl_mode_serves_manifest` |  | `—` | `None` | 213 |  |
| `tests/integration/test_dsl_roundtrip.py` | `test_create_app_dsl_mode_serves_schema` |  | `—` | `None` | 228 |  |
| `tests/integration/test_dsl_roundtrip.py` | `test_ws_action_triggers_dsl_rerun_and_publishes_events` |  | `—` | `None` | 242 | Full WS round-trip: action in → DSL _dsl_action_handler fires → ack + notification out. |
| `tests/integration/test_dsl_roundtrip.py` | `test_config_outside_ui_fn_is_preserved` |  | `—` | `None` | 304 | lcars.config() called before run() must survive the BUILD-phase context reset. |
| `tests/integration/test_dsl_roundtrip.py` | `test_config_visual_language_is_preserved` |  | `—` | `None` | 330 | lcars.config(visual_language=...) should flow into manifest metadata. |
| `tests/integration/test_dsl_roundtrip.py` | `test_config_strict_renderer_is_preserved` |  | `—` | `None` | 351 | lcars.config(strict_renderer=...) should flow into manifest metadata. |
| `tests/integration/test_dsl_roundtrip.py` | `test_create_app_legacy_mode_unchanged` |  | `—` | `None` | 371 | Legacy create_app() still works when the default fixtures dir exists. |
...
| `frontend/scripts/generate-contract.mjs` | — | — | — | `ajv/dist/2020.js`, `ajv/dist/standalone/index.js`, `json-schema-to-typescript`, `node:crypto`, `node:fs/promises`, `node:path`, `node:process` | — |
...
| `frontend/src/types/contract.generated.ts` | `Manifest`, `Layout`, `Header`, `Sidebar`, `SidebarItem`, `SidebarSegment`, `Meta`, `Pages`, `Page`, `Row`, `Column`, `Text`, `Hint`, `StatusTile`, `MetricOptions`, `WidgetFeedback`, `ValueFormat`, `Alert`, `AlertOptions`, `ActionSpec`, `Value1`, `InteractionOptions`, `Button`, `AtomGlyph`, `ButtonOptions`, `Payload`, `Toggle`, `ToggleOptions`, `Checkbox`, `Radio`, `SelectOption`, `ChoiceOptions`, `RadioToggle`, `Select`, `TextInput`, `TextInputOptions`, `ValidationOptions`, `NumberInput`, `NumberInputOptions`, `FileUpload`, `Form`, `FormOptions`, `Table`, `TableOptions`, `TableColumn`, `TableFilter`, `TablePagination`, `TableSelection`, `TableSort`, `TableRow`, `TableCell`, `LinkSpec`, `TableDetailText`, `TableDetailStatus`, `TableDetailLink`, `TableDetailAction`, `Value10`, `TableDetailTable`, `LineChart`, `ChartOptions`, `ReferenceLine`, `AxisOptions`, `SeriesPointSet`, `Sparkline`, `SparklineOptions`, `Candlestick`, `OhlcPoint`, `ChartMarker`, `FinancialChartOptions`, `Renko`, `Shader`, `ShaderOptions`, `Uniforms`, `Gauge`, `MeterOptions`, `ProgressBar`, `Markdown`, `MarkdownOptions`, `LogViewer`, `LogOptions`, `VideoHls`, `VideoOptions`, `ThreeScene`, `ThreeSceneOptions`, `ThreeSceneCamera`, `ThreeSceneControls`, `Props`, `NodeCanvas`, `GraphDocument`, `GraphComment`, `GraphEdge`, `GraphGroup`, `GraphLayer`, `GraphNode`, `Values`, `GraphReroute`, `NodeTemplate`, `GraphField`, `GraphFieldOption`, `GraphPort`, `GraphViewport`, `GraphExecutionState`, `Nodes1`, `GraphNodeExecution`, `NodeCanvasOptions`, `GraphWorkspace`, `GraphWorkspaceOptions`, `GraphWorkspaceDocument`, `WorkspaceAction`, `Metadata`, `CanonicalPlane`, `WorkspaceCompleteness`, `GraphRevision`, `WorkspaceProjection`, `WorkspaceProjectionBinding`, `WorkspaceRecord`, `Fields1`, `Trees`, `WorkspaceTreeValue`, `WorkspaceTreeNode`, `Fields2`, `Slots`, `WorkspaceInteractionPolicy`, `ProposalPlane`, `ProposalChange`, `ValidationFinding`, `ValidationTarget`, `WorkspaceReaderState`, `ReaderNavigationEntry`, `WorkspaceSelection`, `ReaderFilter`, `ReaderFocus`, `LayerState`, `GraphLayerState`, `Positions`, `StepSelections`, `IngestionReceipt`, `ReceiptObject`, `WorkspaceRecordSchema`, `WorkspaceRecordAppearance`, `WorkspaceFieldSchema`, `WorkspaceChoice`, `WorkspaceSearchField`, `WorkspaceTreeSchema`, `WorkspaceTreePartSchema`, `WorkspaceTreeSlotSchema`, `WorkspaceValidationRule`, `Parameters`, `MicButton`, `MicOptions`, `LcarsBox`, `LcarsSweep`, `LcarsBracket`, `LcarsHeader`, `HeaderOptions`, `LcarsBar`, `CompositionArea`, `AuthoredComposition`, `Popup`, `WebUISettings`, `SupportPanel`, `Frontier`, `FrontierData`, `FrontierCurrent`, `FrontierItem`, `WebRef`, `AssertionCard`, `AnchorCard`, `AnchorData`, `SourceRef`, `TriState`, `TriStateData`, `ConstraintBand`, `ConstraintData`, `PositionedClaim`, `ConstraintCondition`, `NumericInterval`, `QuantityRef`, `GapPanel`, `CommitmentSelector`, `CommitmentData`, `CommitmentOption`, `GapData`, `GapContender`, `AssertionData`, `ContextQualifier`, `FrameworkRef`, `SupportData`, `SupportCompleteness`, `SupportEnvironment`, `SupportAtom`, `ContainerOptions`, `TextOptions` | — | — | — | `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface` |
| `frontend/src/types/contract.test.ts` | — | — | — | `./contract`, `node:fs`, `node:path` | — |
| `frontend/src/types/contract.ts` | `Manifest`, `SidebarSegment`, `SidebarItem`, `Page`, `Row`, `Column`, `WidgetBase`, `Hint`, `WidgetFeedback`, `InteractionOptions`, `LinkSpec`, `ActionSpec`, `ValueFormat`, `BaseOptions`, `TextOptions`, `MarkdownOptions`, `HeaderOptions`, `MetricOptions`, `AlertOptions`, `MeterOptions`, `ValidationOptions`, `ButtonOptions`, `ToggleOptions`, `ChoiceOptions`, `TextInputOptions`, `NumberInputOptions`, `FormOptions`, `ContainerOptions`, `TextWidget`, `StatusTileWidget`, `AlertWidget`, `ProgressBarWidget`, `MarkdownWidget`, `ButtonWidget`, `AtomGlyph`, `ToggleWidget`, `CheckboxWidget`, `SelectWidget`, `RadioWidget`, `RadioToggleWidget`, `SelectOption`, `TextInputWidget`, `NumberInputWidget`, `FileUploadWidget`, `FormWidget`, `TableWidget`, `TableCell`, `TableDetailText`, `TableDetailStatus`, `TableDetailLink`, `TableDetailAction`, `TableDetailTable`, `TableRow`, `TableColumn`, `TableSort`, `TableFilter`, `TablePagination`, `TableSelection`, `TableOptions`, `TableState`, `Series`, `LineChartWidget`, `SparklineWidget`, `AxisOptions`, `ReferenceLine`, `ChartOptions`, `SparklineOptions`, `FinancialChartOptions`, `OhlcPoint`, `ChartMarker`, `CandlestickWidget`, `RenkoWidget`, `ShaderOptions`, `ShaderWidget`, `GaugeWidget`, `LogViewerWidget`, `LogOptions`, `VideoHlsWidget`, `VideoOptions`, `ThreeSceneWidget`, `ThreeSceneCamera`, `ThreeSceneControls`, `ThreeSceneOptions`, `GraphPort`, `GraphFieldOption`, `GraphField`, `NodeTemplate`, `GraphNode`, `GraphLayer`, `GraphEdge`, `GraphReroute`, `GraphGroup`, `GraphComment`, `GraphViewport`, `GraphDocument`, `GraphNodeExecution`, `GraphExecutionState`, `NodeCanvasOptions`, `NodeCanvasState`, `NodeCanvasWidget`, `GraphWorkspaceWidget`, `MicButtonWidget`, `MicOptions`, `LcarsBoxWidget`, `LcarsSweepWidget`, `LcarsBracketWidget`, `LcarsHeaderWidget`, `LcarsBarWidget`, `CompositionAreaWidget`, `AuthoredCompositionWidget`, `PopupWidget`, `WebUISettingsWidget`, `WebRef`, `SupportCompleteness`, `SupportData`, `SupportPanelWidget`, `FrontierData`, `FrontierWidget`, `AssertionData`, `AssertionCardWidget`, `WebSource`, `AnchorData`, `AnchorCardWidget`, `TriStateData`, `TriStateWidget`, `ConstraintData`, `ConstraintBandWidget`, `GapData`, `GapPanelWidget`, `CommitmentData`, `CommitmentSelectorWidget` | — | `isObject`, `hasString`, `hasBoolean`, `hasNullableString`, `isSidebarSegments`, `isStrictBandRole`, `isStrictLaneMode`, `isStrictLaneRole`, `isStrictWidgetRole`, `isWidgetLike`, `isColumn`, `isRow`, `isPage`, `hasRuntimeShellShape`, `isManifest` | `./contract.generated`, `./manifestValidator.generated`, `./workspace` | `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `type`, `interface`, `interface`, `interface`, `type`, `type`, `type`, `interface`, `interface`, `interface`, `interface`, `type`, `type`, `interface`, `type`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `type`, `interface`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `type`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `type`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `type`, `type`, `type`, `type`, `interface`, `type`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `interface`, `type`, `type`, `const` |
| `frontend/src/types/manifestValidator.generated.ts` | — | — | `validate23`, `validate22`, `validate21`, `validate33`, `validate32`, `validate37`, `validate36`, `validate41`, `validate40`, `validate45`, `validate44`, `validate48`, `validate52`, `validate51`, `validate55`, `validate58`, `validate62`, `validate61`, `validate66`, `validate65`, `validate69`, `validate80`, `validate71`, `validate85`, `validate84`, `validate89`, `validate91`, `validate88`, `validate83`, `validate96`, `validate95`, `validate100`, `validate99`, `validate104`, `validate103`, `validate107`, `validate111`, `validate110`, `validate115`, `validate114`, `validate118`, `validate122`, `validate121`, `validate126`, `validate125`, `validate130`, `validate129`, `validate134`, `validate133`, `validate140`, `validate139`, `validate138`, `validate144`, `validate146`, `validate137`, `validate150`, `validate153`, `validate156`, `validate161`, `validate160`, `validate159`, `validate155`, `validate167`, `validate170`, `validate166`, `validate175`, `validate174`, `validate179`, `validate183`, `validate182`, `validate181`, `validate188`, `validate187`, `validate192`, `validate152`, `validate149`, `validate197`, `validate196`, `validate285`, `validate284`, `validate288`, `validate320`, `validate353`, `validate388`, `validate387`, `validate425`, `validate424`, `validate428`, `validate431`, `validate430`, `validate471`, `validate470`, `validate474`, `validate434`, `validate478`, `validate391`, `validate487`, `validate486`, `validate355`, `validate322`, `validate290`, `validate520`, `validate256`, `validate228`, `validate200`, `validate31`, `validate997`, `validate30`, `validate29`, `validate28`, `validate27`, `validate20` | `ajv/dist/runtime/ucs2length` | `const`, `validate20` |
...
| `src/lcars_ui/_static/assets/GLTFLoader-qXE60D7C.js` | — | `extends`, `extends`, `extends` | `P`, `De`, `F`, `ke`, `I`, `tt`, `X`, `Z`, `nt`, `rt`, `it`, `Q`, `at`, `a`, `c`, `ct`, `lt`, `a`, `n` | — | — |
| `src/lcars_ui/_static/assets/GraphWorkspace-DzGyTeHL.js` | — | — | `f`, `S`, `C`, `w`, `T`, `D`, `O`, `k`, `A`, `M`, `P`, `F`, `R`, `z`, `H`, `U`, `W`, `G`, `K`, `q`, `J`, `Y`, `X`, `Z`, `ue`, `Je`, `Ye`, `mt`, `Tt`, `de`, `n`, `n`, `i`, `n`, `n`, `n`, `i`, `a`, `a`, `r`, `c`, `r`, `v`, `t`, `e`, `re`, `t` | — | — |
| `src/lcars_ui/_static/assets/jsx-runtime-OQpaS_Dv.js` | — | — | `p`, `_`, `v`, `y`, `T`, `E`, `D`, `O`, `A`, `j`, `M`, `N`, `L`, `s` | — | — |
| `src/lcars_ui/_static/assets/lightweight-charts.production-B7hGuU5E.js` | — | `extends`, `extends`, `extends`, `extends`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `n`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends` | `e`, `t`, `e`, `r`, `n`, `a`, `o`, `s`, `c`, `e`, `u`, `m`, `h`, `g`, `_`, `v`, `y`, `x`, `S`, `C`, `w`, `T`, `E`, `ee`, `D`, `O`, `k`, `A`, `oe`, `de`, `fe`, `pe`, `me`, `he`, `Te`, `N`, `He`, `rt`, `it`, `ft`, `gt`, `_t`, `vt`, `yt`, `R`, `Tt`, `Et`, `z`, `jt`, `B`, `Mt`, `Nt`, `V`, `H`, `U`, `Pt`, `Lt`, `Ht`, `Wt`, `Gt`, `Kt`, `qt`, `Jt`, `Yt`, `Xt`, `Qt`, `tn`, `un`, `dn`, `fn`, `mn`, `yn`, `bn`, `Cn`, `wn`, `Tn`, `En`, `Dn`, `kn`, `An`, `jn`, `Mn`, `Nn`, `Fn`, `K`, `q`, `In`, `Ln`, `zn`, `Bn`, `J`, `Y`, `Un`, `Wn`, `Gn`, `Kn`, `qn`, `Yn`, `Xn`, `Zn`, `Qn`, `tr`, `cr`, `lr`, `ur`, `dr`, `fr`, `pr`, `mr`, `hr`, `gr`, `X`, `_r`, `Z`, `vr`, `yr`, `br`, `xr`, `Cr`, `wr`, `Tr`, `Er`, `Dr`, `Or`, `Ar`, `jr`, `Mr`, `Nr`, `Pr`, `Fr`, `Rr`, `Br`, `Ur`, `Wr`, `Gr`, `Kr`, `qr`, `Jr`, `Yr`, `Xr`, `Zr`, `ri`, `ui`, `fi`, `pi`, `mi`, `Q`, `Ti`, `Ei`, `Di`, `Oi`, `ki`, `ji`, `Mi`, `Ni`, `Pi`, `Ii`, `zi`, `n`, `i`, `t`, `i`, `t`, `t`, `a`, `n`, `r`, `s`, `r`, `e`, `i`, `o`, `r` | — | — |
| `src/lcars_ui/_static/assets/three.module-C5rh5wLt.js` | — | `e`, `e`, `e`, `e`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `e`, `e`, `extends`, `e`, `e`, `extends`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `extends`, `extends`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `e`, `extends`, `extends`, `e`, `extends`, `extends`, `e`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `extends`, `ext
`, `Bg`, `C`, `Wg`, `Gg`, `m`, `h`, `g`, `_`, `v`, `y`, `b`, `x`, `S`, `C`, `Kg`, `t`, `n`, `r`, `i`, `a`, `qg`, `Jg`, `Yg`, `a`, `o`, `s`, `c`, `l`, `u`, `d`, `Xg`, `t`, `n`, `Zg`, `Qg`, `e_`, `t_`, `s`, `c`, `n_`, `a`, `o`, `s`, `c`, `l`, `u`, `r_`, `n`, `r`, `d_`, `v`, `y`, `b`, `x`, `f_`, `n`, `r`, `i`, `ce`, `ue`, `de`, `fe`, `pe`, `me`, `_e`, `ve`, `ye`, `be`, `xe`, `Se`, `Ce`, `P`, `we`, `Te`, `Ee`, `F`, `De`, `I`, `L`, `Oe`, `ke`, `Ae`, `je`, `Me`, `Ne`, `Pe`, `Fe`, `Ie`, `Le`, `R`, `Re`, `p_`, `h`, `g`, `_`, `v`, `y`, `b`, `x`, `S`, `C`, `w`, `T`, `E`, `D`, `k`, `A`, `ee`, `te`, `j`, `ne`, `re`, `M`, `ie`, `N`, `ce`, `le`, `ue`, `de`, `fe`, `pe`, `me`, `he`, `ge`, `_e`, `ve`, `ye`, `Se`, `Ce`, `P`, `we`, `Te`, `Ee`, `m_`, `n`, `A`, `ee`, `te`, `re`, `M`, `ie`, `oe`, `x_`, `n`, `r`, `i`, `a`, `o`, `s`, `c`, `l`, `u`, `d`, `f`, `p`, `m`, `h`, `S_`, `c`, `l`, `u`, `d`, `f`, `p`, `m`, `h`, `g`, `_`, `v`, `y`, `T_`, `Ce`, `we`, `Je`, `et`, `tt`, `nt`, `rt`, `it`, `at`, `ot`, `n`, `ut`, `ft`, `pt`, `ht`, `gt`, `_t`, `vt`, `yt`, `bt`, `xt`, `St`, `Ct`, `wt`, `Tt`, `Et`, `e`, `r`, `t`, `e`, `n`, `t`, `c`, `a`, `n`, `n`, `n`, `n`, `c`, `e`, `e`, `e`, `r`, `t`, `t` | — | — |
...
| `frontend/src/styles/lcars.css` | — | `--okuda-orange`, `--okuda-golden`, `--okuda-canary`, `--okuda-sunflower`, `--okuda-blue`, `--okuda-mariner`, `--okuda-lilac`, `--okuda-hopbush`, `--okuda-red`, `--okuda-ice`, `--okuda-white`, `--ink-label`, `--ink-value`, `--role-frame`, `--role-rail-a`, `--role-rail-b`, `--role-rail-c`, `--role-rail-d`, `--role-rail-e`, `--role-rail-f`, `--role-control`, `--role-readout`, `--role-band`, `--role-alert`, `--ink-dark`, `--ink-light`, `--bar-h`, `--bar-h-thin`, `--footer-h`, `--rail-w`, `--elbow-overhang`, `--elbow-w`, `--elbow-h`, `--elbow-h-bot`, `--seam`, `--cap`, `--unit`, `--font`, `--font-display`, `--mono`, `--track`, `--track-wide`, `--dur-instant`, `--dur-fast`, `--dur-base`, `--dur-slow`, `--ease-lcars`, `--ease-sweep`, `--stagger`, `--accent`, `--top`, `--bot`, `--r-mosaic`, `--mosaic`, `--sub`, `--gcanvas-wire`, `--atom-color`, `--edge-color`, `--tri-color`, `--set-color` | `lcars-alert-pulse`, `lcars-mic-pulse`, `lcars-blink`, `lcars-detail-in`, `lcars-detail-out`, `lcars-meter-scan`, `lcars-panel-in`, `lcars-panel-out`, `lcars-field-expand`, `lcars-readout-flicker`, `lcars-logline-in`, `lcars-note-in`, `lcars-note-out`, `lcars-hint-in`, `lcars-hint-out` | — | — |
| `frontend/src/widgets/nodecanvas/shapes.css` | — | — | — | — | — |
| `frontend/src/widgets/workspace/workspace.css` | — | — | — | — | — |
| `src/lcars_ui/_static/assets/GraphWorkspace-DuDnQU1Q.css` | — | — | — | — | — |
| `src/lcars_ui/_static/assets/NodeCanvas-rmK9se4N.css` | — | `--xy-edge-stroke-default`, `--xy-edge-stroke-width-default`, `--xy-edge-stroke-selected-default`, `--xy-connectionline-stroke-default`, `--xy-connectionline-stroke-width-default`, `--xy-attribution-background-color-default`, `--xy-minimap-background-color-default`, `--xy-minimap-mask-background-color-default`, `--xy-minimap-mask-stroke-color-default`, `--xy-minimap-mask-stroke-width-default`, `--xy-minimap-node-background-color-default`, `--xy-minimap-node-stroke-color-default`, `--xy-minimap-node-stroke-width-default`, `--xy-background-color-default`, `--xy-background-pattern-dots-color-default`, `--xy-background-pattern-lines-color-default`, `--xy-background-pattern-cross-color-default`, `--xy-node-border-default`, `--xy-node-border-selected-default`, `--xy-handle-background-color-default`, `--xy-selection-background-color-default`, `--xy-selection-border-default`, `--xy-resize-background-color-default`, `--xy-node-color-default` | `dashdraw` | — | — |
| `src/lcars_ui/_static/assets/index-F2vmfoB3.css` | — | `--okuda-orange`, `--okuda-golden`, `--okuda-canary`, `--okuda-sunflower`, `--okuda-blue`, `--okuda-mariner`, `--okuda-lilac`, `--okuda-hopbush`, `--okuda-red`, `--okuda-ice`, `--okuda-white`, `--ink-label`, `--ink-value`, `--role-frame`, `--role-rail-a`, `--role-rail-b`, `--role-rail-c`, `--role-rail-d`, `--role-rail-e`, `--role-rail-f`, `--role-control`, `--role-readout`, `--role-band`, `--role-alert`, `--ink-dark`, `--ink-light`, `--bar-h`, `--bar-h-thin`, `--footer-h`, `--rail-w`, `--elbow-overhang`, `--elbow-w`, `--elbow-h`, `--elbow-h-bot`, `--seam`, `--cap`, `--unit`, `--font`, `--font-display`, `--mono`, `--track`, `--track-wide`, `--dur-instant`, `--dur-fast`, `--dur-base`, `--dur-slow`, `--ease-lcars`, `--ease-sweep`, `--stagger`, `--accent`, `--top`, `--bot`, `--r-mosaic`, `--mosaic`, `--sub`, `--gcanvas-wire`, `--atom-color`, `--edge-color`, `--tri-color`, `--set-color`, `--lightningcss-light`, `--lightningcss-dark` | `lcars-alert-pulse`, `lcars-mic-pulse`, `lcars-blink`, `lcars-detail-in`, `lcars-detail-out`, `lcars-meter-scan`, `lcars-panel-in`, `lcars-panel-out`, `lcars-field-expand`, `lcars-readout-flicker`, `lcars-logline-in`, `lcars-note-in`, `lcars-note-out`, `lcars-hint-in`, `lcars-hint-out` | — | — |
...
| `src/lcars_ui/_static/index.html` | — | — | — | `/assets/index-_sZRY3mr.js` | `/assets/index-F2vmfoB3.css` |
