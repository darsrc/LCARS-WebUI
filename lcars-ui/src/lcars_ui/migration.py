...
# Effects stay exported from the package root in v7. They are not widgets and
# are never reported as flat widget calls.
ROOT_EFFECTS = frozenset(
    {"append_log", "notify", "set_alert_condition", "set_theme", "update"}
)
