  ...
  return (
    <section className="lcars-web-panel lcars-support" style={accentStyle(widget.color)}>
      ...
      <div className="lcars-web-body">
        ...
        <WebChildren children={widget.children} depth={depth} handlers={handlers} />
      </div>
    </section>
  );
}

function FrontierControl({
  widget,
  handlers,
}: {
...
function AnchorCardControl({ widget }: { widget: Extract<Widget, { type: "anchor_card" }> }) {
  const { data } = widget;
  return (
...
function CommitmentSelectorControl({
  widget,
  handlers,
}: {
...
function WidgetBody({
  ...
  switch (widget.type) {
    ...
    case "support_panel":
      return <SupportPanelControl depth={depth} handlers={handlers} widget={widget} />;

    case "frontier":
      return <FrontierControl handlers={handlers} widget={widget} />;

    case "assertion_card":
      return <AssertionCardControl depth={depth} handlers={handlers} widget={widget} />;
    ...
    case "gap_panel":
      return <GapPanelControl depth={depth} handlers={handlers} widget={widget} />;
